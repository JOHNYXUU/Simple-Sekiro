...
{
    public class LightAttack01 : PlayerAnimState
    {
        private float _enterTime;

        private bool _hasPlayAudio;
        
        public LightAttack01()
        {
            ...
            EnterMap.IntValues.Add(AnimParams.LightAttackIndex, 1);
        ...
        public override int UpdateAnim(PlayerEntity entity)
        {
            ...
            if (Time.time - _enterTime >= Config.lightAttack01AudioBeginTime && !_hasPlayAudio)
            {
            ...
            if (entity.AttackState == (int)AttackState.LightAttack && entity.LightAttackIndex == 2)
                return (int)AnimState.LightAttack02;

            if (entity.AttackState == (int)AttackState.HeavyAttack)
                return (int)AnimState.HeavyAttack;

            if (entity.AttackState == (int)AttackState.NoAttack && entity.MoveState == (int)MoveState.Idle)
