...
{
    public class LightAttack03 : PlayerAnimState
    {
        private float _enterTime;

        private bool _hasPlayAudio;
        
        public LightAttack03()
        {
            ...
            EnterMap.IntValues.Add(AnimParams.LightAttackIndex, 3);
        ...
        public override int UpdateAnim(PlayerEntity entity)
        {
            ...
            if (Time.time - _enterTime >= Config.lightAttack03AudioBeginTime && !_hasPlayAudio)
            {
            ...
            if (entity.AttackState == (int)AttackState.LightAttack && entity.LightAttackIndex == 4)
                return (int)AnimState.LightAttack04;
