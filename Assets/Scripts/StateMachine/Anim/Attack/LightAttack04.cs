...
{
    public class LightAttack04 : PlayerAnimState
    {
        private float _enterTime;

        private bool _hasPlayAudio;
        
        public LightAttack04()
        {
            ...
            EnterMap.IntValues.Add(AnimParams.LightAttackIndex, 4);
        ...
        public override int UpdateAnim(PlayerEntity entity)
        {
            ...
            if (Time.time - _enterTime >= Config.lightAttack04AudioBeginTime && !_hasPlayAudio)
            {
            ...
            if (entity.AttackState == (int)AttackState.LightAttack && entity.LightAttackIndex == 5)
                return (int)AnimState.LightAttack05;
